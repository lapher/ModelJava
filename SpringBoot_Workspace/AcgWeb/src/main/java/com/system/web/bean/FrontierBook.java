...
public class FrontierBook implements Serializable {
	...
	*/
	...
	public String toString() {
		return "FrontierBook [picDir=" + picDir + ", name=" + name + ", price=" + price + ", ffno=" + ffno + ", topic="
				+ topic + ", auther=" + auther + ", series=" + series + ", other=" + other + "]";
	}
