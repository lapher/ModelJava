...
//	private static final Logger log = LogManager.getLogger(Teller_InformationController.class);
	...
	public String mainPage(Model model) {
		model.addAttribute("mainPage", "page/beanA");	// 統一小寫
	...
	public String mainSelectPage(Model model) {
		model.addAttribute("mainPage", "select_page/select_BeanA");
		return "model/dashboard";
	}
	...
	public @ResponseBody Map<String, Object> getBeanAll() {
		...
		// SQL
		List<BeanA> beanAll = service.selectAll();
	...
	public @ResponseBody Map<String, Object> getBean(@RequestBody BeanA bean) {
		Map<String, Object> map = new HashMap<>();

		// SQL
		BeanA teller_Information = service.selectID(bean);
	...
	public @ResponseBody Map<String, Object> insertBean(@RequestBody BeanA bean, HttpSession httpSession) {
		Map<String, Object> map = new HashMap<>();
...
//		bean.setMaintainTime(LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")));
		...
		// 重新查詢
		BeanA select_bean = service.selectID(bean);
	...
	public @ResponseBody Map<String, Object> updateBean(@RequestBody BeanA bean, HttpSession httpSession) {
		Map<String, Object> map = new HashMap<>();
...
//		bean.setMaintainTime(LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")));
	...
	public @ResponseBody Map<String, Object> deleteBean(@RequestBody BeanA bean) {
		Map<String, Object> map = new HashMap<>();
